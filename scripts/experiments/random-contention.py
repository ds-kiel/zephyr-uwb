...
if __name__ == '__main__':
    ...
    file_path = '/Users/christian/Promotion/ScalableRanging/zephyr-uwb/scripts/data/testbed/kiel/experiment-frame-log-cir.json'
    ...
    features = [
        'fp-index',
        'fp-ampl1', 'fp-ampl2', 'fp-ampl3',
        'cir-pwr', 'rx-pacc', 'std-noise'
    ]
